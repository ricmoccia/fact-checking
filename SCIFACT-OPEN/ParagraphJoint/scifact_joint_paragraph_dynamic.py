...
if __name__ == "__main__":
    ...
    argparser.add_argument('--checkpoint', type=str, default = "scifact_roberta_joint_paragraph_dynamic.model")
    argparser.add_argument('--log_file', type=str, default = "joint_paragraph_roberta_dynamic_performances.jsonl")
    argparser.add_argument('--prediction', type=str, default = "prediction_scifact_roberta_joint_paragraph_dynamic.jsonl")
